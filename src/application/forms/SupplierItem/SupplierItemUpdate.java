 ...
 * @author DELL
 */
public class SupplierItemUpdate extends javax.swing.JDialog {

    /**
     * Creates new form SupplierItemUpdate
     */
    ...
    public SupplierItemUpdate(java.awt.Dialog parent, boolean modal) {
      super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        btnUpdateSupplierItem = new javax.swing.JButton();
        btnCancel = new javax.swing.JButton();
        cmbManufacturer = new javax.swing.JComboBox<>();

        setDefaultCloseOperation(javax.swing.WindowConstants.DISPOSE_ON_CLOSE);
        setTitle("Supplier Item Update");
        ...
        btnUpdateSupplierItem.setText("Update");
        btnUpdateSupplierItem.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnUpdateSupplierItemActionPerformed(evt);
            }
        });
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addComponent(btnUpdateSupplierItem, javax.swing.GroupLayout.PREFERRED_SIZE, 71, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(10, 10, 10)
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(btnUpdateSupplierItem, javax.swing.GroupLayout.PREFERRED_SIZE, 26, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addContainerGap(25, Short.MAX_VALUE))
        );
    ...
    private void btnUpdateSupplierItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateSupplierItemActionPerformed
        SupplierItem supplierItem = supplierItemController.findSupplierItemById(supplierItemId);
        supplierItem.setSupplierItemUOM(cmbManufacturer.getSelectedItem().toString());
        supplierItem.setSupplierItemDescription(txtDescription.getText().trim());
        ...
        if (supplierItemController.update(supplierItem)) {
            JOptionPane.showMessageDialog(this, "Supplier Item updated successfully. ", "Success Message", JOptionPane.INFORMATION_MESSAGE);

            txtDescription.requestFocus();
            //clearFileds();
        } else {
            JOptionPane.showMessageDialog(this, "Error in updating Supplier Item.", "Error Message", JOptionPane.ERROR_MESSAGE);
            txtDescription.requestFocus();
            //clearFileds();
        }

    }//GEN-LAST:event_btnUpdateSupplierItemActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SupplierItemUpdate.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                SupplierItemUpdate dialog = new SupplierItemUpdate(new javax.swing.JDialog(), true);
    ...
    private javax.swing.JButton btnUpdateSupplierItem;
    ...
    public void setSupplierItemUpdate(SupplierItem supplierItem) {
       
        supplierItemId = supplierItem.getSupplierItemId();
        //cmbDiscount.setSelectedIndex(0);
        cmbManufacturer.setSelectedIndex(0);
        txtDescription.setText(supplierItem.getSupplierItemDescription());
